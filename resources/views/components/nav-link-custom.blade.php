...
<a {{ $attributes->merge(['class' => "relative inline-flex items-center px-1 pt-1 border-b-2 h-full text-sm font-medium leading-5 transition-colors duration-200 focus:outline-none"])
